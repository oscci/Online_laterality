...
The basic demographics questionnaire asked participants to report age, gender, years in education, and whether they were bilingual. We also askedquestions about handedness and footedness. For handedness we asked: which is your dominant hand (i.e. which hand do you prefer to use for tasks such as writing, cutting, and catching a ball)? For footedness we asked: Pwhich foot do you normally use to step up on a ladder/step? For both questions, participants could answer "left", "right", or "no preference".
