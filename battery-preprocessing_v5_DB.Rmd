...
demo_dat_R <- read_csv("./data/demographics_R.csv", na = c("empty", "NA")) # read in data
demo_dat_L <- read_csv("./data/demographics_L.csv", na = c("empty", "NA")) # read in data
...
miles_dat_R <- read_csv("./data/Miles_R.csv", na = c("empty", "NA")) # read in data
miles_dat_L <- read_csv("./data/Miles_L.csv", na = c("empty", "NA")) # read in data
miles_dat <- rbind(miles_dat_R, miles_dat_L)
#porta_dat_R <- read_csv("./dat2/Porta_R.csv", na = c("empty", "NA")) # read in data
porta_dat_L <- read_csv("./data/Porta_L.csv", na = c("empty", "NA")) # read in data
...
```{r EHI, warning=FALSE}
EHI_R <- read_csv("./data/EHI_R.csv", na = "empty") # read in data
EHI_L <- read_csv("./data/EHI_L.csv", na = "empty") # read in data
...
# read data
lexTALE_L <- read_csv("./data/LexTale_L.csv", na = "empty")
lexTALE_R <- read_csv("./data/lexTale_R.csv", na = "empty")
...
# Set directory
for (d in 1:2){
  data_file <- "./data/day1_combined.csv"
  
  if (d ==2){
    data_file <-  "./data/day2_combined.csv"
  }
...
cor1 <- cor(allsum$Day1_DL_acc_LI,allsum$Day2_DL_acc_LI)
...
cor2<-cor(allsum$Day1_DL_RT_LI,allsum$Day2_DL_RT_LI)
