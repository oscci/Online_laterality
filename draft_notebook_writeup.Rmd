...
```{r makecontingencies,echo=FALSE,include=TRUE}
...
```{r showtabr,echo=FALSE,include=TRUE}
tabr%>%
  kable() %>%
  kable_styling("condensed")
```
Table 3: Dichotic listening
```{r showtabd,echo=FALSE,include=TRUE}
tabd%>%
  kable() %>%
  kable_styling("condensed")
```
Table 4: Chimeric faces
```{r showtabc,echo=FALSE,include=TRUE}
tabc%>%
  kable() %>%
  kable_styling("condensed")
```
...
```{r prep_dat,echo=FALSE,include=TRUE}
...
```{r showcorrs,echo=FALSE,include=TRUE}
...
```{r dotab5,echo=FALSE,include=TRUE}
corrL%>%
  kable() %>%
  kable_styling("condensed")
```
...
```{r dotab6,echo=FALSE,include=TRUE}
corrR%>%
  kable() %>%
  kable_styling("condensed")
```
...
```{r dotab7,echo=FALSE,include=TRUE}
corrL%>%
  kable() %>%
  kable_styling("condensed")
```
...
```{r dotab8,echo=FALSE,include=TRUE}
corrR%>%
  kable() %>%
  kable_styling("condensed")
...
```{r Roger_mod_left,echo=FALSE,include=TRUE}
model1<-"
dichotic1~~0*rhyme1
...
```{r Roger_mod_right,echo=FALSE,include=TRUE}
